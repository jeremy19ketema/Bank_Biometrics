...
const routePermissions: Record<string, string[]> = {
  ...
  "/transactions": ["BANK_MANAGER", "SUPER_ADMIN", "ACCOUNTANT"],
  "/approvals": ["BANK_MANAGER", "SUPER_ADMIN", "SUPER_ADMIN_IT", "SUPER_ADMIN_MANAGER"],
  "/accountants": ["BANK_MANAGER", "SUPER_ADMIN", "SUPER_ADMIN_MANAGER"],
  "/customers": ["BANK_MANAGER", "SUPER_ADMIN", "ACCOUNTANT"],
  "/reports": ["BANK_MANAGER", "SUPER_ADMIN"],
  "/biometrics": ["ACCOUNTANT", "BRANCH_IT", "IT_SUPPORT", "BANK_MANAGER", "SUPER_ADMIN"],
  "/hr": ["HR", "SUPER_ADMIN"],
